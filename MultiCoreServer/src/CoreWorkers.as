...
package 
{
	...
	public class CoreWorkers
	{
		
		[Embed(source="../workerswfs/MultiCoreServerWorker.swf", mimeType="application/octet-stream")]
		private static var MultiCoreServerWorker_ByteClass:Class;
		
		public static function get CheckOffServerWorkerBytes():ByteArray
		{
			return new MultiCoreServerWorker_ByteClass();
		}
